export default [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address', name: 'dst', type: 'address' },
      { indexed: false, internalType: 'uint256', name: 'value', type: 'uint256' },
    ],
    name: 'LPTokenClaimed',
    type: 'event',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'string', name: 'log', type: 'string' }],
    name: 'Log',
    type: 'event',
  },
  {
  ...
  {
    inputs: [
      { internalType: 'bool', name: 'agreesToTermsOutlinedInLiquidityGenerationParticipationAgreement', type: 'bool' },
    ],
    name: 'addLiquidity',
    outputs: [],
  ...
  { inputs: [], name: 'claimLPTokens', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
  ...
  {
    inputs: [{ internalType: 'address', name: '_transferCheckerAddress', type: 'address' }],
